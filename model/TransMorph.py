...
import numpy as np
import model.configs_TransMorph as configs
...
class TransMorph(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(len(out_feats),out_feats[0].shape,out_feats[1].shape,out_feats[2].shape,out_feats[3].shape)
        ...
        emb_global = out_feats[3].view(-1, 768).mean(dim=0)
        return out, flow, emb_global
